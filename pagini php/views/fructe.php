            ...
            <div class="articles">
                <div class="articleContainer">
                    ...
                    <div class="articleTitle">
                        <h2>
                           <?php getCategorie(11223344,'NUME_PRODUS'); ?>
                        </h2>
                    </div>
                    <div class="pret">
                            <h1>Subtotal:</h1>
                            <?php getCategorie(11223344,'PRET'); ?> Lei
                    </div>
                    <div class="cantitate">
                        <h2>Cantitate:  <?php getCategorie(11223344,'NUMAR_BUCATI'); ?> buc</h2>
                    </div>
                    <div class="buyButton">
                ...
                <div class="articleContainer">
                    ...
                    <div class="articleTitle">
                        <h2>
                        <?php getCategorie(11223345,'NUME_PRODUS'); ?>

                        </h2>
                    </div>
                    <div class="pret">
                            <h1>Subtotal:</h1>
                            <?php getCategorie(11223345,'PRET'); ?> Lei
                    </div>
                    <div class="cantitate">
                        <h2>Cantitate:  <?php getCategorie(11223345,'NUMAR_BUCATI'); ?> buc</h2>
                    </div>
                    <div class="buyButton">
                        <button class="btn normal" type="button">
                            Cumpara
                ...
                <div class="articleContainer">
                    ...
                    <div class="pret">
                            <h1>Subtotal:</h1>
                            <?php getCategorie(11223346,'PRET'); ?> Lei
                    </div>
                    <div class="cantitate">
                        <h2>Cantitate:  <?php getCategorie(11223346,'NUMAR_BUCATI'); ?> buc</h2>
                    </div>
                    <div class="buyButton">
                        <button class="btn normal" type="button">
                            Cumpara
                    ...
                    <div class="articleContainer">
                        ...
                        <div class="articleTitle">
                            <h2>
                            <?php getCategorie(11223347,'NUME_PRODUS'); ?>

                            </h2>
                        </div>
                        <div class="pret">
                                <h1>Subtotal:</h1>
                                <?php getCategorie(11223347,'PRET'); ?> Lei
                        </div>
                        <div class="cantitate">
                        <h2>Cantitate:  <?php getCategorie(11223347,'NUMAR_BUCATI'); ?> buc</h2>
                    </div>
                        <div class="buyButton">
                            <button class="btn normal" type="button">
                                Cumpara
